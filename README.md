...
# It helps provide access to state across all levels and branches of components without having to continually manage passing props. It comes at some cost however, as it can be harder to create new components. 
